        ...
        <split-pane 
          ...
          <div 
            ...
            <split-pane 
              :style="{height: '100%'}" 
              direction="vertical" 
              v-model="triggerOffsetV">
              <div 
                class="introduce-left-con" 
                slot="top" 
                style="background: #EDE3A0;height: 100%;padding: 30px;">
              ...
              <div 
                slot="bottom" 
                style="background: #A2EDB6;height: 100%;">
                <split-pane 
                  ref="pane" 
                  :style="{height: '100%'}" 
                  direction="horizontal" 
                  v-model="triggerOffsetMin">
                  <div 
                    slot="left" 
                    style="background: #EDACE2;height: 100%;"/>
                  <div 
                    slot="trigger" 
          ...
          <div 
            class="split-pane-right-con" 
            slot="right" 
            style="background: #8FB5ED;height: 100%;">
            <p>是否是在最小距离处： {{ atMin }}</p>
            <p>是否是在最大距离处： {{ atMax }}</p>
          </div>
        </split-pane>
