<template>
  <div 
    ref="wraper" 
    :class="wraperClasses" 
    @DOMMouseScroll="handleDOMMouseWheel" 
    ...
    <div 
      v-show="percentY < 1 && !disScrollY" 
      :class="scrollYClasses" 
      :style="scrollYStyles">
      <div 
        :class="[`${prefix}-scroll-bar`, `${prefix}-scroll-bar-y`]" 
        :style="scrollBarYStyles" 
        @mousedown="handleMousedownScrollBarY"/>
    </div>
    <div 
      v-show="percentX < 1 && !disScrollX" 
      :class="scrollXClasses" 
      :style="scrollXStyles">
      <div 
        :class="[`${prefix}-scroll-bar`, `${prefix}-scroll-bar-x`]" 
        :style="scrollBarXStyles" 
        @mousedown="handleMousedownScrollBarX"/>
    </div>
    <div 
      v-show="percentX < 1 && percentY < 1" 
      :class="`${prefix}-place-holder`"/>
  </div>
</template>
