    ...
    <Row :gutter="10">
      ...
      <Card>
        ...
        <Row :gutter="10">
          ...
          <Row 
            ...
            justify="center" 
            align="middle" 
            class="image-editor-con1-preview-con">
            <div id="preview1"/>
          </Row>
          <div class="image-editor-con1-btn-con margin-top-10">
            ...
            <label 
              class="filelabel" 
              for="fileinput1"><Icon type="image"/>&nbsp;选择图片</label>
            <span><Button 
              @click="handlecrop1" 
              type="primary" 
              icon="crop">裁剪</Button></span>
          </div>
          <Modal v-model="option1.showCropedImage">
            <p slot="header">预览裁剪之后的图片</p>
            <img 
              :src="option1.cropedImg" 
              alt="" 
              v-if="option1.showCropedImage" 
              style="width: 100%;">
          </Modal>
                        </Col>
        </Row>
      ...
      <Card>
        ...
        <Row :gutter="10">
          <Col 
            span="14" 
            class="image-editor-con2">
          <div class="cropper">
            <img 
              id="cropimg2" 
              src="../../../images/cropper-test.png" 
              alt="">
          </div>
                        </Col>
          <Col 
          ...
          <div 
            ...
            <ButtonGroup>
              <Button 
                @click="cropper2.rotate(-90)" 
                type="primary"><Icon 
                  :size="14" 
                  type="arrow-return-left"/></Button>
              <Button 
                @click="cropper2.rotate(90)" 
                type="primary"><Icon 
                  :size="14" 
                  type="arrow-return-right"/></Button>
              <Button 
                @click="cropper2.zoom(0.1)" 
                type="primary"><Icon 
                  :size="14" 
                  type="plus-round"/></Button>
              <Button 
                @click="cropper2.zoom(-0.1)" 
                type="primary"><Icon 
                  :size="14" 
                  type="minus-round"/></Button>
              <Button 
                @click="cropper2.scaleX(-cropper2.getData().scaleX)" 
                type="primary"><Icon 
                  :size="14" 
                  type="android-more-horizontal"/></Button>
              <Button 
                @click="cropper2.scaleY(-cropper2.getData().scaleY)" 
                type="primary"><Icon 
                  :size="14" 
                  type="android-more-vertical"/></Button>
            </ButtonGroup>
          </div>
                        </Col>
        </Row>
      ...
      <Card>
        ...
        <Row :gutter="10">
          ...
          <Row>
            <Col 
              span="24" 
              class="image-editor-con3-btn-box">
            <input 
              type="file" 
              accept="image/png, image/jpeg, image/gif, image/jpg" 
              ...
              class="fileinput" >
            <label 
              class="filelabel filelabel3" 
              for="fileinput3"><Icon type="image"/>&nbsp;选择图片</label>
                            </Col>
          </Row>
          <Row class="margin-top-10">
            <Col 
            ...
            <Tooltip 
              ...
              <Button 
                ...
                type="primary"><Icon 
                  :size="18" 
                  type="checkmark-round"/></Button>
            </Tooltip>
            <Tooltip 
              content="取消裁剪" 
              placement="bottom">
              <Button 
                @click="cropper3.clear()" 
                type="primary"><Icon 
                  :size="18" 
                  type="close-round"/></Button>
            </Tooltip>
            <Tooltip 
              content="不可用" 
              placement="bottom">
              <Button 
                @click="cropper3.disable()" 
                type="primary"><Icon 
                  :size="18" 
                  type="android-lock"/></Button>
            </Tooltip>
            <Tooltip 
              content="可用" 
              placement="bottom">
              <Button 
                @click="cropper3.enable()" 
                type="primary"><Icon 
                  :size="18" 
                  type="android-unlock"/></Button>
            </Tooltip>
                            </Col>
          </Row>
          <Row 
          ...
          <Row 
            ...
            <Tooltip 
              ...
              <Button 
                ...
                type="primary"><Icon 
                  :size="18" 
                  type="android-arrow-back"/></Button>
            </Tooltip>
            <Tooltip 
              content="右移" 
              placement="bottom">
              <Button 
                ...
                type="primary"><Icon 
                  :size="18" 
                  type="android-arrow-forward"/></Button>
            </Tooltip>
            <Tooltip 
              content="上移" 
              placement="bottom">
            ...
            <Tooltip 
              ...
              <Button 
                ...
                type="primary"><Icon 
                  :size="18" 
                  type="android-arrow-down"/></Button>
            </Tooltip>
                            </Col>
          </Row>
          <Row class="margin-top-10">
            ...
            <Button 
              ...
              style="width: 190px;" 
              icon="crop" 
              type="primary">裁剪</Button>
                            </Col>
            <Modal v-model="option3.showCropedImage">
              <p slot="header">预览裁剪之后的图片</p>
              <img 
                :src="option3.cropedImg" 
                alt="" 
                v-if="option3.showCropedImage" 
                style="width: 100%;">
            </Modal>
          </Row>
                    </Col>
          ...
          <Row 
            ...
            justify="center" 
            align="middle" 
            class="image-editor-con3-preview-con">
            <div id="preview3"/>
          </Row>
                    </Col>
        </Row>
