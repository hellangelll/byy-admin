...
<template>
  <div>
    <Row>
      ...
      <Col 
        span="8" 
        class="padding-left-10 height-100" >
      <Card>
        <p slot="title">
          <Icon type="clipboard"/>
          表格1操作记录( 拖拽 )
        ...
        <Row style="height: 374px;">
          ...
          <Card>
            <div class="record-tip-con">
              <div 
                v-for="(item, index) in table1.draggingRecord" 
                :key="index" 
                class="record-item">
    ...
    <Row class="margin-top-10">
      ...
      <Card>
        ...
        <Row style="height: 374px;">
          ...
          <Card>
            <div class="record-tip-con">
              <div 
                v-for="(item, index) in table2.chooseRecord" 
                :key="index" 
                class="record-item">
                {{ item }}
              </div>
      ...
      <Card>
        <DragableTable 
          ...
          :columns-list="columnsList" 
          v-model="tableData" 
          @on-start="handleOnstart2" 
          @on-end="handleOnend2" 
          @on-choose="handleOnchoose2" />
      </Card>
            </Col>
    </Row>
  </div>
