  ...
  <div class="preview-main">
    ...
    <Row class="margin-top-20">
      ...
      <div>
        <Card>
          <h1>{{ articleTitle }}</h1>
          <p class="preview-publish-time"><Icon type="android-alarm-clock"/>&nbsp;发布时间：{{ publishTime }}</p>
          <div class="preview-tags-con">
            <b class="preview-tip"><Icon type="ios-pricetags-outline"/>&nbsp;标签：</b><Tag 
          ...
          <div 
            class="preview-content-con" 
            v-html="content"/>
          <div class="preview-classifition-con">
            <b class="preview-tip"><Icon type="navicon-round"/>&nbsp;目录：</b>
            <a 
              class="preview-classifition-item" 
              v-for="item in classificationSelected" 
              :key="item">
              <Icon type="android-folder-open"/>
              {{ item }}
            </a>
          </div>
        </Card>
