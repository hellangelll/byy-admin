  ...
  <div>
    <Row>
          ...
          <div class="article-link-con">
            <transition name="fixed-link">
              <FormItem 
                ...
                label="固定链接">
                <span>
                  <span key="pathfixedtext">{{ fixedLink }}</span><span 
                    key="pathText" 
      ...
      <Card>
        ...
        <p class="margin-top-10">
          <Icon type="eye"/>&nbsp;&nbsp;公开度：&nbsp;<b>{{ Openness }}</b>
          <Button 
            v-show="!editOpenness" 
            size="small" 
        ...
        <Row class="margin-top-20 publish-button-con">
          ...
          <span class="publish-button"><Button 
            @click="handlePublish" 
        ...
        <Card>
          ...
          <Tabs type="card">
            ...
            <TabPane label="常用目录">
              <div class="classification-con">
                <CheckboxGroup 
                  v-model="offenUsedClassSelected" 
                  @on-change="setClassificationInOffen">
                  <p 
                    v-for="item in offenUsedClass" 
                    :key="item.title">
